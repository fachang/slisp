...
;(apply-generic 'exp x y) discovers that (get 'exp '(complex complex)) -> #f,
;and tries to call coercion procdures. however, the coercion procdure 
;complex->complex does not do coercion, thus the recursive call 
;(apply-generic 'exp x y) is idenetical, the recursive process would never stop.

...
(define z (make-complex-from-real-imag 5 12))

(magnitude z)

;the evaluation progress of (magnitude z) is as below:
;(magnitude '(complex rectangle 5 12))
;
;(apply-generic 'magnitude '(complex rectangle 5 12))  ---->  #1
;
;(apply (get 'magnitude '(complex)) '(rectangle 5 12))
;
;(apply-generic 'magnitude '(rectangle 5 12))  ---->  #2
;
;(apply (get 'magnitude '(rectangle)) '(5 12))
;
;(sqrt (+ (square (real-part '(5 12)))
;         (square (imag-part '(5 12)))))
;

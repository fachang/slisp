...
(define (install-complex-package)
  ...
  (define (equ?-complex z1 z2)
    (and (= (real-part z1) (real-part z2))
         (= (imag-part z1) (imag-part z2))))
  (define (raise z)
    (make-polynomial 'x (list (list 0 (tag z)))))
  (define (project z)
...
(define p1 (make-polynomial 'y '((1 1.0) (0 1.0))))
(define p2 (make-polynomial 'x (list (list 3 int) (list 2 rat) (list 0 real))))
(define p3 (make-polynomial 'x (list (list 3 comp) (list 2 p1) (list 0 10.5))))

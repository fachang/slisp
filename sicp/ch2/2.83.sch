...
(define (raise-nth x n)
  (if (= n 0)
      x
      (raise (raise-nth x (- n 1)))))

(define int (make-integer 10))
(define rat (make-rational 3 4))
(define real (make-real 5.0))
(define comp (make-complex-from-real-imag 5.0 5.0))

(test raise-nth int 3)
(test raise-nth rat 2)
(test raise-nth real 1)
(test raise-nth comp 0)

...
(define p1 (make-polynomial 'y '(dense 1.0 1.0)))
(define p2 (make-polynomial 'x (list 'dense int rat 0 real)))
(define p3
  (make-polynomial 'x (list 'sparse (list 3 comp) (list 2 p1) (list 0 10.5))))

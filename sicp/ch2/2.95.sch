...
(test greatest-common-divisor q1 q2)    ;not p1 !

;the reason is simple. consider calculating (remainder 4x+5 3x+1). first
;divide 4x+5 with 3x+1, which is 4/3. then the remainder is found by
;calculate 4x+5 - (4/3) * (3x+1). if the CAS system take 4/3 as 1.333,
;the final result will be imprecise. if the CAS system take 4/3 as
;rational, than the result will be polynomial with rational coefficients.
